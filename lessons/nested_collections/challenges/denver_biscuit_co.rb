...
week_days.each do |week_day|
    denver_biscuit_co[:hours][0][:open].each do |day|
        formatted[week_day] = {start: day[:start], end: day[:end]}
    end
end

p formatted

{:Monday=>{:start=>"0800", :end=>"1500"}, :Tuesday=>{:start=>"0800", :end=>"1500"}, :Wednesday=>{:start=>"0800", :end=>"1500"}, :Thursday=>{:start=>"0800", :end=>"1500"}, :Friday=>{:start=>"0800", :end=>"1500"}}